...
if __name__ == "__main__":
    ...
    parser.add_argument("--datadir", type=str, default="/eos/experiment/neutplatform/protodune/experiments/ProtoDUNE-VD/beam_csv_files/", help="Directory containing the data files")
