...
from waffles.np02_utils.AutoMap import dict_uniqch_to_module, dict_module_to_uniqch, strUch, getModuleName
...
if __name__ == "__main__":
    ...
    argp.add_argument("--datadir", type=str, default="./data/", help="Directory where the processed waveform files are located.")
    argp.add_argument("--nwaveforms", type=int, default=None, help="Maximum number of waveforms to load for each channel.")
    argp.add_argument("--outputdir", type=str, default="./data/", help="Directory where the average waveforms will be saved.")
    argp.add_argument("--cutyaml", type=str, default="few_cuts_xe.yaml", help="YAML file containing the cuts to apply to the waveforms.")
