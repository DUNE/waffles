...
apa_1_data = [  [UniqueChannel(104, 7   ),  UniqueChannel(104, 5 ), UniqueChannel(104, 2 ), UniqueChannel(104, 0    )],
                ...
                [UniqueChannel(104, 27  ),  UniqueChannel(104, 35), UniqueChannel(104, 32), UniqueChannel(104, 30   )],
                [UniqueChannel(104, 21  ),  UniqueChannel(104, 33), UniqueChannel(104, 34), UniqueChannel(104, 36   )],
