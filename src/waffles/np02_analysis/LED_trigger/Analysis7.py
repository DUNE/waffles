...
def process_waveforms(led_path, channel, max_samples=1024):
    ...
    hist_fig.update_layout(
        title="Histogram of Max position - run 36030 - ch 44", #- ch 46",
...
if __name__ == "__main__":
    ...
    led_path = "data/processed_np02vd_raw_run036110_0000_df-s04-d0_dw_0_20250425T133944.hdf5_structured.hdf5"
    channel = 44 #46
