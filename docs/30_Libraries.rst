...
For more details, see the :doc:`31_data_classes <31_data_classes>`.
...
For more details, see the :doc:`32_input <32_input>`.

np04
-------------
Particular functions and classes for NP04 analysis can be found here. For more details, see the :doc:`33_np04 <33_np04>`.
...
For more details, see the :doc:`34_plotting <34_plotting>`.
